package com.springboot.communityback.generator;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dsc.setUrl(
                "jdbc:mysql://localhost:3306/community_db?useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("user");// 模块名，可以跟数据表的名称一致
        pc.setParent("com.springboot.communityBack");
