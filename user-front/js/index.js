! function(e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t(require(
			"django_test/app_test/static/js/vue")) : "function" == typeof define && define.amd ? define("ELEMENT", [
			"django_test/app_test/static/js/vue"
		], t) : "object" == typeof exports ? exports.ELEMENT = t(require("django_test/app_test/static/js/vue")) : e
		.ELEMENT = t(e.Vue)
					...
					if ("A" === t.tagName) {
						...
						if ("years" === this.selectionMode) {
							var n = this.value || [],
								...
								s = r > -1 ? [].concat(n.slice(0, r), n.slice(r + 1)) : []
								.concat(n, [new Date(i)]);
							this.$emit("pick", s)
					...
					handleMonthTableClick: function(e) {
						...
						if ("A" === t.tagName && (t = t.parentNode.parentNode), "DIV" === t
							.tagName && (t = t.parentNode), "TD" === t.tagName && !fe(t,
								"disabled")) {
							var i, n, r, s = t.cellIndex,
								a = 4 * t.parentNode.rowIndex + s,
								o = this.getMonthOfCell(a);
							if ("range" === this.selectionMode) this.rangeState.selecting ? (
								o >= this.minDate ? this.$emit("pick", {
									minDate: this.minDate,
									maxDate: o
								}) : this.$emit("pick", {
									minDate: o,
								...
								var l = this.value || [],
									...
									}) >= 0 ? (i = l, (r = "function" == typeof(n = function(
									e) {
										return e.getTime() === o.getTime()
									}) ? T(i, n) : i.indexOf(n)) >= 0 ? [].concat(i.slice(0,
										r), i.slice(r + 1)) : i) : [].concat(l, [o]);
								this.$emit("pick", c)
				...
				return e.prototype.setData = function(e) {
					...
					if (!0 !== this.store.lazy || !this.store.load || this.loaded || this.loading &&
						...
						this.store.load(this, function(n) {
							t.childNodes = [], t.doCreateChildren(n, i), t.loaded = !0, t
								.loading = !1, t.updateLeafState(), e && e.call(t, n)
						})
					}
				}, No(e, [{
					key: "label",
							...
							i = function(t, i, n) {
								i.domVisible || "none" === ge(i, "display") || "hidden" === ge(i,
									...
									(i.instance.visible = !0, i.instance.hiding = !1) : (Object
										...
										.originalPosition && "sticky" !== i.originalPosition && me(
											t, "el-loading-parent--relative"), n.modifiers
										.fullscreen && n.modifiers.lock && me(t,
		...
		var Cl = function() {
				...
				if (!h.a.prototype.$isServer) {
					...
					return function(e, t, i) {
						...
						.originalPosition && "sticky" !== i.originalPosition && me(t,
							"el-loading-parent--relative"), e.fullscreen && e.lock && me(t,
							"el-loading-parent--hidden"), t.appendChild(i.$el), h.a.nextTick(
					function() {
							i.visible = !0
						}), e.fullscreen && (xl = i), i
				}
